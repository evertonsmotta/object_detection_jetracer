...
const static int kNumClass = 8;
const static int kBatchSize = 1;
const static int kGpuId = 0;
const static int kInputH = 320;  // Voltando para 320x320 como estava funcionando
const static int kInputW = 320;  // Voltando para 320x320 como estava funcionando
